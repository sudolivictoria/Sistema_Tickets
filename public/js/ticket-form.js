...
(function() {
    ...
    window.filtrarTipos = function(categoriaId) {
        ...
        const filtrados = window.todosLosTipos.filter(tipo => tipo.categoria_id == categoriaId);
    ...
    const initForm = () => {
        ...
        if (categoriaSelect.value) {
            ...
            if (tipoSelect && tipoSelect.value) {
                tipoSelect.value = tipoSelect.getAttribute('value') || tipoSelect.value;
                //--mostrar descripcion
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.querySelector('select[name="tipo_solicitud_id"]').addEventListener('change', function() {
            ...
            const tipoSeleccionado = window.todosLosTipos?.find(t => t.id == this.value);

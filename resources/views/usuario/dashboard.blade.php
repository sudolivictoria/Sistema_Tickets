        ...
        <div class="relative z-10 flex flex-col xl:flex-row justify-between xl:items-end gap-6">
            ...
            <div class="w-full md:w-auto md:pb-4 md:px-2">
                <a href="{{ route('usuario.crear-ticket') }}"
                    class="w-full md:w-32 flex items-center justify-center gap-2 bg-secondary text-primary font-black py-3 rounded-xl shadow-lg hover:scale-[1.02] transition-all uppercase text-[10px] tracking-widest"

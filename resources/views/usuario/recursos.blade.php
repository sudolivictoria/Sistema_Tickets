    ...
    <div class="p-8 bg-slate-50 min-h-screen">
        ...
        <div class="flex gap-3 mb-10 overflow-x-auto pb-2">
            ...
            @foreach ($categorias as $cat)
                <button type="button"
                    class="filter-btn bg-white font-black text-primary  border-2 border-slate-200 px-6 py-2 rounded-full uppercase text-xs tracking-wider hover:border-[#04003B] hover:text-[#04003B] transition"
        ...
        <div class="bg-white w-full h-full max-w-6xl rounded-3xl shadow-2xl overflow-hidden flex flex-col relative">
            <div class="bg-slate-50 px-8 py-4 flex justify-between items-center border-b border-slate-200">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 id="visor-titulo"
                            class="font-black text-[#04003B] uppercase tracking-tight text-lg leading-tight">Vista Previa
                            del
                            Recurso</h3>

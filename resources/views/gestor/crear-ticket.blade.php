...
@section('content')
    <div class="max-w-4xl w-full mx-auto p-8">
        ...
        <form action="{{ route('gestor.tickets.store') }}" method="POST" enctype="multipart/form-data"
            class="space-y-8 bg-white p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100" id="formCrearTicket"
            data-redirect-success="{{ route('gestor.mis-tickets') }}">
            @csrf
            <!--asunto del ticket-->

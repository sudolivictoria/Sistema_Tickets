                        ...
                        <div class="lg:col-span-1 space-y-6">
                            ...
                            <div
                                ...
                                <div class="relative z-10">
                                    ...
                                    <h4 class="text-sm font-black uppercase tracking-wider mb-2">Gestión</h4>
                                    <p class="text-[14px] text-slate-300 leading-relaxed font-medium">
                                        Revise periódicamente las solicitudes <span
                                            class="text-primary font-bold italic underline">PENDIENTES.</span>
                                    </p>
                                </div>
                                <span

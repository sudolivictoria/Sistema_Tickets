...
<head>
    ...
    <title>Help Desk ISTU - Iniciar sesión</title>
    ...
    <style>
        * { font-family: 'Bree Serif', serif !important; }
        body { margin: 0; min-height: 100vh; background: linear-gradient(to bottom, #001764 0%, #004e23 50%, #5b8f00 100%); }
        .login-container { min-height: 100vh; width: 100%; display: flex; align-items: center; justify-content: center; position: fixed; inset: 0; z-index: 999; }
        .login-card { width: 90%; max-width: 420px; position: relative; }
        .bg1, .bg2 { position: absolute; inset: 0; border-radius: 2rem; transform: scale(1.05); z-index: 1; }
        .bg1 { background-color: #0c003f; transform: rotate(6deg) scale(1.05); }
        .bg2 { background-color: #120064; transform: rotate(-6deg) scale(1.05); }
        .card-content { position: relative; z-index: 10; background: white; border-radius: 2rem; padding: 40px 40px 30px; }
        .card-content h1 { text-align: center; font-size: 24px; font-weight: 900; color: #005797; margin-top: 0; margin-bottom: 24px; }
        .field { margin-bottom: 14px; }
        .field label { display: block; font-size: 11px; font-weight: bold; color: #005c0c; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 5px; }
        ...
        <div class="card-content">
            <div style="text-align: center; margin-bottom: 16px;">
                <a href="/" style="display:block;">
                    <img src="{{ asset('images/logo_istu.png') }}" alt="Logo" style="height: 140px; width: 140px; object-fit: contain; margin:auto;">
                </a>
            </div>
            ...
            <form method="POST" action="{{ route('login.post') }}" style="display:flex; flex-direction:column; gap: 15px;">
                @csrf
                <div class="field">
                ...
                <div class="field" style="position: relative;">
                    ...
                    <button type="button" id="toggle-password" style="position: absolute; top: 36px; right: 12px; background: transparent; border: none; cursor: pointer; padding: 0;">

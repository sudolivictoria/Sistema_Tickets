    ...
    <div class="flex items-center justify-center min-h-screen p-4 sm:p-6">
        ...
        <div class="relative bg-white rounded-3xl shadow-2xl max-w-lg w-full flex flex-col max-h-[70vh] transform transition-all border-t-8 border-primary z-10 animate-fade-in overflow-hidden">
            ...
            <div class="p-5 sm:p-6 border-b border-slate-100 shrink-0 bg-white relative">
                <div class="absolute top-4 right-4 flex items-center gap-1.5 px-3 py-1 bg-green-50 border border-green-100 rounded-full text-green-600 font-black text-[11px] uppercase tracking-wider shadow-sm animate-pulse" id="wrapperCountdown">
                ...
                <div class="pr-24 space-y-2">
                    ...
                    <div class="flex items-center gap-1.5 text-slate-500 font-semibold text-xs">
                        <span class="material-symbols-outlined text-[16px] text-primary">calendar_month</span>
                        <label class="text-[10px] font-black uppercase tracking-widest text-green-950">Fecha de Apertura:</label>
                        <span id="modalFechaApertura" class="font-black text-green-900 bg-lime-100/50 px-2 py-0.5 rounded-md">---</span>
                    </div>
                </div>
            </div>

            <!-- 2. CUERPO CON SCROLL INTERNO -->
            <div class="p-5 sm:p-6 overflow-y-auto custom-scrollbar space-y-5 flex-1 bg-slate-50/50">
                ...
                <div id="seccion-historico-comentarios" class="pt-2 border-t border-slate-200/60">

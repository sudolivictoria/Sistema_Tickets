...
<head>
    ...
    <style>
        ...
        .card-abierto .stat-label {
            color: #c2410c;
        }
        .card-abierto .stat-value {
            color: #ea580c;
        }
        .card-proceso {
        ...
        .card-proceso .stat-label {
            color: #1d4ed8;
        }
        .card-proceso .stat-value {
            color: #2563eb;
        }
        .card-cerrado {
        ...
        .card-cerrado .stat-label {
            color: #15803d;
        }
        .card-cerrado .stat-value {
            color: #16a34a;
        }
        .card-total {
    ...
    @foreach($tickets as $ticket)
        ...
        <div class="ticket-card" style="border-left: 5px solid {{ $themeColor }};">
            <table class="card-header">
                <tr>
                    <td class="col-id" style="color: {{ $themeColor }};">#TK{{ str_pad($ticket->id, 5, '0', STR_PAD_LEFT) }}
                    </td>
                    ...
                    <td class="col-prio">
                        <div class="info-value">
                            <span class="badge"
                                style="background-color: {{ $prioBg }}; color: {{ $prioColor }}; border: 1px solid {{ $prioBg }};">
                                {{ $prioName }}
                            </span>
                        </div>
                    </td>

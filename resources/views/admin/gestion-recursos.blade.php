    ...
    <div class="p-8 bg-slate-50 min-h-screen">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden">
                    ...
                    <form id="formAgregar" action="{{ route('admin.manuales.store') }}" method="POST"
                        ...
                        <div>
                            ...
                            <input type="text" name="titulo" class="w-full mt-1 p-3 bg-slate-50 border rounded-xl"
                                required>
                        </div>
                        <div>
                            ...
                            <select name="categoria_id" class="w-full mt-1 p-3 bg-slate-50 border rounded-md" required>
                                @foreach ($categorias as $categoria)
                                    <option value="{{ $categoria->id }}">{{ $categoria->nombre_categoria_manual }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
            ...
            <div id="modalVisor"
                ...
                <div
                    class="bg-white w-full h-full max-w-6xl rounded-3xl shadow-2xl overflow-hidden flex flex-col relative">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 id="visor-titulo"
                                    ...
                                    del
                                    Recurso</h3>
                                <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Sistema de
                                    Gestión
                                    de
                                    Manuales</p>
                            </div>
                    ...
                    <div id="contenedor-visor"
                        class="flex-1 bg-slate-800 flex items-center justify-center overflow-hidden">
                    </div>
                </div>
            </div>
        @endsection
        ...
        @push('page-scripts')
            @vite(['resources/js/gestion-recursos.js'])
        @endpush

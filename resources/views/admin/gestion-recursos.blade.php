    ...
    <div class="p-8 bg-slate-50 min-h-screen">
        ...
        <div class="flex gap-3 mb-10 overflow-x-auto pb-2">
            <button onclick="filtrar('all', event)"
                class="filter-btn active bg-white text-blue-900 px-6 py-2 rounded-full border-2 border-blue-900 font-semibold uppercase text-xs tracking-wider hover:border-blue-900 hover:text-white transition">
                Todos
            </button>
        ...
        <div class="bg-white w-full h-full max-w-6xl rounded-3xl shadow-2xl overflow-hidden flex flex-col relative">
            <div class="bg-slate-50 px-8 py-4 flex justify-between items-center border-b border-slate-200">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 id="visor-titulo"
                            class="font-black text-blue-900 uppercase tracking-tight text-lg leading-tight">Vista Previa
                            del
                            Recurso</h3>
